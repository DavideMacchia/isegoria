...
- **Done:** the audit's six concrete defects (`docs/08` §0-bis); the decisions D17–D41;
  ...
  precondition of the latent re-check (D37, T53) and the proper evaluator score with
  odds-scale weights and the 30-outcome probation (D33, D36, T50). Details and evidence:
  [Completed work](#completed-work).
- **Open:** the design revisions D34, D35, D38–D41 and the model half of D37 (D32, D33,
  D36 and D37's precondition are done: T49, T50, T53); the defects found by the third
...
epoch. The decisions D32–D41 correct them (done: D32, T49; D33 and D36, T50; D37's precondition, T53). Several change the
...
6. T53 (S) — done (2026-09-25): the anchor-reliability gate and the differential-gap
   diagnostic.
7. T50 (M) — done (2026-09-25): the proper evaluator score, odds weights, probation
   30; then T51 (M) — the change detector.
...
- **Phase 1.** T64 and T65, the two severe defects, are done, and so are T62 and T49
  ...
  followed the D27 decision and is done. T50 is done; T51 and T52 build on its score
  (the per-item scores it computes are the CUSUM's input, and D35 adds scored outcomes
  to it). T53 is done; T54 builds
