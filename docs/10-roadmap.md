...
- **Done:** the audit's six concrete defects (`docs/08` §0-bis); the decisions D17–D41;
  ...
  gate of the latent re-check (D37, T53). Details and evidence:
  [Completed work](#completed-work).
- **Open:** the design revisions D33–D41 (D32 is done, T49; D37's precondition, T53); the defects found by the
...
- **Phase 1.** T64 and T65, the two severe defects, are done, and so are T62 and T49
  ...
  followed the D27 decision and is done. T50 before T51 and T52. T53 is done; T54 builds on it. T55
