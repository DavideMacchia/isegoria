...
- **Done:** the audit's six concrete defects (`docs/08` §0-bis); the decisions D17–D41;
  ...
  detector on model residuals (D39, T56), panel diversification (D40, T57) and live
  outcomes with randomized exploration (D35, T52). Details and evidence:
  [Completed work](#completed-work).
- **Open:** the design revisions D37, D38, D41 (D32 is done, T49; D33 and D36, T50; D34, T51; D35, T52; D37's precondition, T53; D39 and D40, T56 and T57); the defects found by the
...
- **Phase 1.** T64 and T65, the two severe defects, are done, and so are T62 and T49
  ...
  followed the D27 decision and is done. T50, T51 and T52 are done. T53 is done; T54 builds on it. T55
