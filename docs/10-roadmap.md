...
- **Done:** the audit's six concrete defects (`docs/08` §0-bis); the decisions D17–D41;
  ...
  (D34, T51), the band's extra round of reviewers (D26, T60) and the coordination
  detector on model residuals (D39, T56). Details and evidence:
  [Completed work](#completed-work).
- **Open:** the design revisions D35, D37, D38, D40, D41 (D32 is done, T49; D33 and D36, T50; D34, T51; D37's precondition, T53; D39, T56); the defects found by the
...
9. T56 (M), then T57 (M) — coordination on residuals (done 2026-09-25), then panel diversification.
...
- **Phase 1.** T64 and T65, the two severe defects, are done, and so are T62 and T49
  ...
  needs its evidence procedure specified first and comes last. T57 needs T56, done. T24/T25
