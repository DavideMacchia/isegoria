...
- **Done:** the audit's six concrete defects (`docs/08` §0-bis); the decisions D17–D41;
  ...
  pseudo-observation inside the author's average (D27, T61) and the anchor-reliability
  precondition of the latent re-check (D37, T53). Details and evidence:
  [Completed work](#completed-work).
- **Open:** the design revisions D33–D41 (D32 is done, T49; D37's precondition, T53); the
  defects found by the third review (2026-09-24), all but T64, T65, T62, T59 and T61; the network runtime
...
epoch. The decisions D32–D41 correct them (D32 is done: T49; D37's precondition: T53). Several change the
...
- **Phase 1.** T64 and T65, the two severe defects, are done, and so are T62 and T49
  ...
  followed the D27 decision and is done. T50 before T51 and T52. T53 is done; T54 builds
