...
- **Done:** the audit's six concrete defects (`docs/08` §0-bis); the decisions D17–D41;
  ...
  detector on model residuals (D39, T56) and panel diversification (D40, T57). Details
  and evidence: [Completed work](#completed-work).
- **Open:** the design revisions D35, D37, D38, D41 (D32 is done, T49; D33 and D36, T50; D34, T51; D37's precondition, T53; D39 and D40, T56 and T57); the defects found by the
