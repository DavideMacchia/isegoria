...
- **Done:** the audit's six concrete defects (`docs/08` §0-bis); the decisions D17–D41;
  ...
  gate of the latent re-check (D37, T53) and the proper evaluator score with odds
  weights and the short probation (D33, D36, T50). Details and evidence:
  [Completed work](#completed-work).
- **Open:** the design revisions D34, D35, D37–D41 (D32 is done, T49; D33 and D36, T50; D37's precondition, T53); the defects found by the
...
epoch. The decisions D32–D41 correct them (D32: T49; D33 and D36: T50; D37's precondition: T53). Several change the
...
7. T50 (M), then T51 (M) — the proper evaluator score (done 2026-09-25), then the change detector.
...
- **Phase 1.** T64 and T65, the two severe defects, are done, and so are T62 and T49
  ...
  followed the D27 decision and is done. T50 is done; T51 and T52 build on it. T53 is done; T54 builds on it. T55
