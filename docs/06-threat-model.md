...
| Long-con (reputation accumulated and spent) | `w_max` cap on the odds scale, where it binds (D33, T50), continuous honeypots; the asymmetric decay is replaced by a CUSUM change detector (D34, T51) | `02` C.4, `05` |
