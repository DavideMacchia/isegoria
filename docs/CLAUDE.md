...
evaluator score T50 and the change detector T51 are done; now the rest of the mechanism,
D35 and D38–D41, and the band re-decision with extra reviewers, T60), then
