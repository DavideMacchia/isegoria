...
evaluator score T50, the change detector T51 and the band's extra round T60 are done;
next T56/T57, coordination on residuals and panel diversification, then the rest of the
mechanism), then
