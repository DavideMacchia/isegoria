...
band items T59, the appeal stake T61 and the anchor-reliability gate T53 are done; now
the rest of the mechanism, D33–D41 — next the evaluator score, T50 and T51 — and the
band re-decision with extra reviewers, T60), then
