...
band items T59, the appeal stake T61, the anchor-reliability gate T53 and the proper
evaluator score T50 are done; now the change detector T51, the rest of the mechanism,
D34–D41, and the band re-decision with extra reviewers, T60), then
