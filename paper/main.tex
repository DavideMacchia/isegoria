...
\date{Working paper, version 0.1 --- September 2026\\[0.3em]
\small Describes the reference implementation at commit \texttt{2ee5e79} of
\url{https://github.com/DavideMacchia/isegoria}}
...
\input{sections/03-level-a}
\input{sections/04-level-b}
\input{sections/05-level-c}
\input{sections/06-collusion}
