...
- **Describes:** the code at commit `2ee5e79` and the design decisions D32–D41 of
  ...
  (2026-09-24), D33 and D36 since T50 and the precondition of D37 since T53 (2026-09-25),
  the rest are planned (roadmap `docs/10` Phase 1.1). The paper is a dated
...
The findings themselves (Sections 3–6) and the other revisions (D34, D35, D38–D41, and
the model half of D37) are unchanged; their tasks are `docs/10` T51, T52 and T54–T57.
