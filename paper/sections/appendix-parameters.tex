...
Probation & 200 scored judgments & weight 0 before; 30 after D36\\
\midrule
\multicolumn{3}{@{}l}{\emph{New in the adopted revisions (all provisional)}}\\
Side-balanced threshold & $\approx0.80$ & probability scale (D32)\\
Evaluator slope $\gamma$ / shrinkage $k_0$ & $\approx35$ / $\approx100$ & odds weights (D33)\\
CUSUM $k$ / $h$ & 0.03 / 1.5 & change detector (D34)\\
Exploration rate $\varepsilon$ & 5\% of gate rejections & measurement only (D35)\\
Anchor KR-20 floor & 0.90 & about 40 anchors (D37)\\
Minimum shared items for coordination & 30 & residual correlation (D39)\\
\bottomrule
\end{tabular}
\end{table}
