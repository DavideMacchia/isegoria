...
false-positive and power tables with confidence intervals. The revisions of
\cref{sec:revisions} address the rows that this paper opened. They are decided but not
implemented, so the table describes the code at the described commit.
